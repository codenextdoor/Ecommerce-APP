    ...
    <div>
      ...
      <div className="p-5">
        ...
        <div className="flex mt-7">
          <div className="flex flex-col flex-1 ">
            ...
            <div className="flex w-[100%] h-auto items-center ">
              <div className="product flex self-start pl-5">
                ...
                />
                <div
                  className="description flex flex-col ml-5 h-auto
                justify-between"
                >
                  <p>
                    {" "}
                    <b className="mr-2">ID:</b>1231241
                  </p>
                  <p>
                    {" "}
                  ...
                  <p className="flex item-center justify-start">
                    ...
                    cursor-pointer bg-sky-500 ml-1 w-[20px] h-[20px]"
                    ></div>
                  </p>
                  <p>
                    {" "}
          ...
          <div className="p-5 flex-[0.4] w-auto h-[40vh] border-2 border-[#8a4af3] rounded-md shadow-lg flex-col items-center  ">
